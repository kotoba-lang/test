...
| profile | description |
|---|---|
| `kotoba-dispatch-followup` | kotoba-lang dispatch-gap followup: kotoba.lang.edn wave2 + dispatch 解消の残課題 (non-dispatch 既存問題・test-runner ブロッカー) を洗い出し 1 finding ずつ propose する |
